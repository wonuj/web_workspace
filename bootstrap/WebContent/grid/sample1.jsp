...
<head>
  ...
  <style type="text/css">
	div.row > div {background-color: #eee; border: 1px solid black;}
  </style>
</head>
<body>
<div class="container">
...
<!-- 
	부트스트랩의 그리드시스템
	* 모든 (<div class="row"></div>)은 적절한 정렬과 패딩을 위해서 
	  <div class="container"> 안에 위치해야 한다.
	* 하나의 행은 하나 이상의 열(<div class="col-*-n">)로 수평 그룹을 만들 수 있다.
	* 모든 컨텐츠(제목, 내용, 테이블, 버튼, 리스트, 폼 ...)는 열(<div class="col-*-n">)안에
	   위치해야 한다.
