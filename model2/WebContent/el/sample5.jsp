...
<div class="container">
	<div class="row">
		<div class="col-12">
			<h1>속성에 값 담기</h1>
			<p>
				PageContext, HttpServletRequest, HttpSession, ServletContext 객체의
				속성에 값 혹은 객체를 저장하고, EL 로 표현하기
			</p>
		</div>
		...
		<%
			...
			// HttpServletRequest의 속성에 저장하기
			request.setAttribute("memberName", "홍길동");
			
			// HttpSession의 속성에 저장하기
			session.setAttribute("loginedUserId", "jhta");
			
			// ServletContext의 속성에 저장하기
			application.setAttribute("conmpanyName", "중앙HTA학원");
			
			// sample6.jsp를 재요청하는 응답을 보낸다.
			// sample5.jsp는 요청을 처리하고, 응답이 완료되었음
			// smaple5.jsp가 사용했던 요청객체/응답객체는 응답완료 후 사라진다.
			// 리다이렉션 이동은 이전페이지의 요청객체/응답객체를 다음 jsp에서 사용할 수 없다.
			...
			// 내부이동은 이전 페이지의 요청객체/응답객체를 다음 jsp에서 재 사용할 수 있다.
