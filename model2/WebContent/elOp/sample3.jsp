...
<div class="container">
	...
	<div class="row">
		<div class="col-12">
			...
			<p>속성명에 해당하는 문자열값의 길이가 0일 때 : ${empty searchKeyword }</p>
			<p>속성명에 해당하는 List의 길이가 0일 때 : ${empty nameList }</p>
			<p>속성명에 해당하는 Map이 비어 있을 때 : ${empty condition }</p>	
			<p>
				empty 연산자는 EL 표현식에 해당하는 값이 존재하지 않거나 그 값이 비어있는 경우 
				(빈 문자열, 길이가 0인 배열, 길이가 0인 콜렉션, 비어있는 Map)
				true를 반환하고, 그 외는 전부 false를 반환한다.
			</p>
		</div>
	</div>
</div>
