...
<div id="navibar">
	...
	%>
		<li class="right <%="login".equals(position) ? "active" : "" %>"><a href="/simple-board/user/loginform.jsp">로그인</a></li>
		<li class="right <%="user".equals(position) ? "active" : "" %>"><a href="/simple-board/user/form.jsp">회원가입</a></li>
	<%	
		}
	%>
	</ul>
